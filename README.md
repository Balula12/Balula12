<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Gustavo%20Santos%20Balula&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32"/>
</div>

<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=53DBF7&center=true&vCenter=true&width=600&lines=🚀+Full-Stack+Developer;💻+React+%7C+Next.js+%7C+Node.js;🎨+UI%2FUX+Enthusiast;🌟+Always+learning+new+technologies;⚡+Harry+Potter+Fan+%26+Code+Wizard" alt="Typing SVG" />
  </a>
</div>

<div align="center">
  <h3>🇧🇷 Desenvolvedor Web Full-Stack | São Paulo, Brasil</h3>
</div>
...
const gustavo = {
    location: "Brasil 🇧🇷",
    currentRole: "Full-Stack Developer @ ggCheckout",
    currentlyLearning: ["TypeScript", "Next.js 14", "Firebase", "Tailwind CSS"],
    funFact: "Harry Potter é minha série de filmes favorita ⚡",
    askMeAbout: ["React", "Node.js", "JavaScript", "Web Development", "UI/UX"],
    technologies: {
